...
class ReReplacerViewList extends JView
{
	...
	protected function addToolbar()
	{
		...
		if ($viewLayout == 'import') {
			...
			// Set ToolBar title
			JToolbarHelper::title(JText::_('NN_IMPORT_ITEMS'), 'rereplacer.png');
			...
			// Set ToolBar title
			JToolbarHelper::title(JText::_('NN_LIST'), 'rereplacer.png');
			// Set toolbar items for the page
			...
			JToolbarHelper::divider();
			$bar->appendButton('Popup', 'help', 'Help', 'http://www.nonumber.nl/rereplacer?ml=1', 'window.getSize().x-100', 'window.getSize().y-100');
		}
	}
