...
//////////////////////////////////////////////////////////////////		
	...
	case 'apply_script_user':
	case 'save_script_user':
    		saveScriptUser($task);
    		break;
		
	case 'apply_submit_text':
	case 'save_submit_text':
    		saveSubmitText($task);
    		break;
...
function save_themes($task){
	...
	{
		case 'apply_themes':
		$msg ='Theme was saved successfully.';
...
function saveCss($task){
	...
	{
		case 'apply_css':
		$msg ='CSS was saved successfully.';
		$link ='index.php?option=com_formmaker&task=edit_css&cid[]='.$row->id;
		break;
		case 'save':
		default:
		$msg = 'CSS was saved successfully.';
...
function saveSubmitText($task){
	...
	{
		case 'apply_submit_text':
		$msg ='Submission text was saved successfully.';
		$link ='index.php?option=com_formmaker&task=edit_submit_text&cid[]='.$row->id;
		break;
		default:
		$msg = 'Submission text was saved successfully.';
		$link ='index.php?option=com_formmaker&task=edit&cid[]='.$row->id;
...
function saveJavaScript($task){
	...
	$row->javascript=JRequest::getVar( 'javascript', '','post', 'string', JREQUEST_ALLOWRAW );
...

	{
		...
		$msg ='JavaScript was saved successfully.';

		$link ='index.php?option=com_formmaker&task=edit_javascript&cid[]='.$row->id;
...
function saveScript($task){
	...
	$row->script1 = JRequest::getVar( 'script1', '','post', 'string', JREQUEST_ALLOWRAW );
	$row->script2 = JRequest::getVar( 'script2', '','post', 'string', JREQUEST_ALLOWRAW );
	if(!$row->store()){
		JError::raiseError(500, $row->getError() );
	}
	...
	{
		case 'apply_script':
		$msg ='The custom text was saved successfully.';
		$link ='index.php?option=com_formmaker&task=edit_script&cid[]='.$row->id;
		break;
		case 'save':
		default:
		$msg = 'The custom text was saved successfully.';
...
function saveScriptUser($task){
	...
	$row->script_user1 = JRequest::getVar( 'script_user1', '','post', 'string', JREQUEST_ALLOWRAW );
	$row->script_user2 = JRequest::getVar( 'script_user2', '','post', 'string', JREQUEST_ALLOWRAW );
	if(!$row->store()){
		JError::raiseError(500, $row->getError() );
	}
	...
	switch ($task)
	{
		case 'apply_script_user':
		$msg ='The custom text was saved successfully.';
		$link ='index.php?option=com_formmaker&task=edit_script_user&cid[]='.$row->id;
		break;
		case 'save':
		default:
		$msg = 'The custom text was saved successfully.';
...
function editSubmit(){
	...
	HTML_contact::editSubmit($rows, $label_id ,$label_order_original,$label_type);
...
function saveSubmit($task){
	...
	{
		case 'save_submit':
		$msg = 'Submission was saved successfully.';
...
function editMyCss(){
	...
	$link = 'index.php?option=com_formmaker&task=edit_css&cid[]='.$row_id;
...
function editMyJavaScript(){

	$mainframe = &JFactory::getApplication();
	$row_id=save('return_id');
	$link = 'index.php?option=com_formmaker&task=edit_javascript&cid[]='.$row_id;
...
function editMyScript(){
	$mainframe = &JFactory::getApplication();
	$row_id=save('return_id');
	$link = 'index.php?option=com_formmaker&task=edit_script&cid[]='.$row_id;
	$mainframe->redirect($link);

}

function editMyScriptUser(){
	$mainframe = &JFactory::getApplication();
	$row_id=save('return_id');
	$link = 'index.php?option=com_formmaker&task=edit_script_user&cid[]='.$row_id;
	$mainframe->redirect($link);

}

function editMySubmitText(){
	$mainframe = &JFactory::getApplication();
	$row_id=save('return_id');
	$link = 'index.php?option=com_formmaker&task=edit_submit_text&cid[]='.$row_id;
	$mainframe->redirect($link);
}
...
function editCss(){
	...
	// display function 
	HTML_contact::editCSS($row);
}

function editSubmitText(){
	...
	// display function 
	HTML_contact::editSubmitText($row);
}
...
function editJavaScript(){
	...
	HTML_contact::editJavaScript($row);
...
function editScriptUser(){
	...
	$row->load( $id);
	// display function 
	HTML_contact::editScriptUser($row);
}
