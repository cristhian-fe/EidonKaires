...
class SnippetsViewItem extends JView
{
	...
	protected function addToolbar()
	{
		...
		// Set ToolBar title
		JToolbarHelper::title(JText::_('NN_ITEM'), 'snippets.png');
		...
		$bar->appendButton('Popup', 'help', 'JHELP', 'http://www.nonumber.nl/snippets?ml=1', 'window.getSize().x-100', 'window.getSize().y-100');
	}
