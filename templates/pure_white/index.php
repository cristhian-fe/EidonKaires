...
$js='<div class="js" ><a id="jslink" target="_blank" href="http://www.joomspirit.com" title="template JoomSpirit">JoomSpirit</a></div>';
...
<link rel="stylesheet" href="<?php echo $this->baseurl ?>/templates/<?php echo $this->template ?>/css/moomenuv.css" type="text/css" />
...
<link rel="stylesheet" media="screen" type="text/css" href="<?php echo $this->baseurl ?>/templates/<?php echo $this->template ?>/css/dynamic_css.php&#63;font=<?php echo $font ; ?>&amp;font_content=<?php echo $font_content ; ?>&amp;color_website_name=<?php echo substr($color_website_name, 1) ; ?>&amp;color_link=<?php echo substr($color_link, 1) ; ?>" />
...
<div id="wrapper" <?php echo ('style="width:'.$width.';"');?>>
  ...
  <div id="footer">
    ...
    <!--  SOCIAL LINKS  -->
    <?php if( ($google1 == 'yes') || ($this->params->get('twitter') != '') || ($this->params->get('blogger') != '') || ($this->params->get('delicious') != '') || ($this->params->get('flickr') != '') || ($this->params->get('facebook') != '') || ($this->params->get('rss') != '') || ($this->params->get('linkedin') != '') || ($this->params->get('myspace') != '') || ($this->params->get('youtube') != '') || ($this->params->get('vimeo') != '') ) : ?>
    <div id="social-links">
    <ul>
  ...
  <center>Eidon-Kaires Srl |Via Meucci 1,S. Giorgio di Nogaro|P.IVA 01866610304|REA UD-01179930936</center>
